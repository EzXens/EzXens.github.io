...
if (isset($_GET["button_search"])) {
    $search = $_GET["search"];
    $query = "SELECT * FROM data_anime WHERE tittle LIKE '%$search%' OR genre LIKE '%$search%' OR studio LIKE '%$search%' OR rating LIKE '%$search%'";
} else {
    $query = "SELECT * FROM data_anime";
}

if (isset($_GET["button_sort"])) {
    $sortOption = $_GET["sort"];
    if ($sortOption === "ascending") {
        $query .= " ORDER BY tittle ASC";
    } elseif ($sortOption === "descending") {
        $query .= " ORDER BY tittle DESC";
    }
}
    ...
    <nav class="header" id="header">
        ...
        <div class="navbar">
            <form action="" method="get">
                ...
                <button class="sort-button" name="button_sort">Sort</button>
            </form>
        </div>
