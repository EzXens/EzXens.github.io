...
<body>
    ...
    <div class="popup">
        <div id="box">
            <p>HALO BANG ADMIN SELAMAT DATANG DI WEBSITE SAYA</p>
    ...
    <nav class="header" id="header">
        ...
        <div class="navbar">
            ...
            <?php
            if (isset($_SESSION['username'])) {
                echo "<div class='user-container'><h3 class='username'>$navText</h3><a href='./login-form/logout.php'><button type='button' class='login'>Logout</button></a></div>";
            } else {
                echo "<div class='user-container'><a href='./login-form/login.php'><button type='button' class='login'>$navText</button></a></div>";
            }
            ?>
