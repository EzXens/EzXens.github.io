...
<body>
    ...
    <div class="popup">
        ...
        echo "<p>HALO BANG <b>$user</b> SELAMAT DATANG DI WEBSITE SAYA</p>";
        }else {
        echo "<p>HALO BANG <b>$user</b> SELAMAT DATANG DI WEBSITE SAYA</p>";
        }
        ?>
    ...
    <nav class="header" id="header">
        ...
        <div class="navbar">
            ...
            <!-- <button class="login"><a href="login-form/login.php" style="text-decoration: none; color: #fff;"></a></button> -->
            <?php
            if (isset($_SESSION['login_user'])) {
                echo "<div class='user-container'><a href='./login-form/logout.php'><button type='button' class='login'>Logout</button></a><h3 class='username'>Welcome!! $user ^.^</h3></div>";
            } else {
                echo "<div class='user-container'><a href='./login-form/login.php'><button type='button' class='login'>Login</button></a><h3 class='username'>You Are $user</h3></div>";
            }
            ?>
