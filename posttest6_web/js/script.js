...
function check()
{
    ...
    if(dark == true)
    {
        ...
        document.getElementById('container').classList.add('container_dark');
        document.getElementById('output').classList.remove('output');
        document.getElementById('output').classList.add('output_dark');
    ...
    else
    {
        ...
        document.getElementById('container').classList.remove('container_dark');
        document.getElementById('container').classList.add('container');
        document.getElementById('output').classList.remove('output_dark');
